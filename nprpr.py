...
qData_folder = "questions"
target_str = "Example 1:"
all_lines = []



#here we are going for collecting all the terms from heading and body of our questions
for i in range(1, 2177):
    file_name = "questions//index.txt"  # Specify the path and name of your file
    line_number = i  # Specify the line number you want to read
    ...
    with open(file_name, 'r', encoding='latin-1') as file:
        for current_line_number, heading in enumerate(file, 1):
...
vocab = {}          # word : no of docs that word is present in like a map<string,int>
